...
Module({
    ...
    await message.sendImageTemplate(await skbuffer("https://i.imgur.com/dEXBa2R.jpeg"),"Working mode configuration","Current mode: "+Config.MODE,buttons);
    }));
Module({
    pattern: 'chatbot',
    fromMe: true,
    ...
    await message.sendImageTemplate(await skbuffer("https://i.imgur.com/dEXBa2R.jpeg"),"🤖 Chatbot configuration","Current status: "+Config.CHATBOT,buttons);
    }));
Module({
    pattern: 'antilink',
    fromMe: true,
