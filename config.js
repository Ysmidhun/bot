...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '𝛥𝛲𝛥𝑅𝛮𝛥 𝛭𝑊𝛩𝐿;★⃝🎶𝙔𝙎_𝙈𝙄𝘿𝙃𝙐𝙉⏤͟͟͞͞★➵͜͡🌸;916282344739;https://i.imgur.com/cFj8BLx.jpeg;https://chat.whatsapp.com/EXjP8kGTPUQBv1LmJqSkGz',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || '★⃝🧚‍♀️𝛥𝛲𝛥𝑅𝛮𝛥 𝛭𝑊𝛩𝐿⏤͟͟͞͞★➵͜͡🌸',
